...
class Klaviyo(object):
    ...
    def track(self, event, email=None, id_=None, properties=None, customer_properties=None,
    ...
    def track_once(self, event, email=None, id_=None, properties=None, customer_properties=None,
        timestamp=None, ip_address=None, is_test=False):
        ...
        return self.track(event, email=email, id_=id_, properties=properties, customer_properties=customer_properties,
            ip_address=ip_address, is_test=is_test)

    def identify(self, email=None, id_=None, properties=None, is_test=False):
        if email is None and id_ is None:
            raise KlaviyoException('You must identify a user by email or ID.')
