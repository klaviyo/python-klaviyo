...
class Klaviyo(object):
    ...
    def track(self, event, email=None, id=None, properties=None,
    ...
    def track_once(self, event, email=None, id=None, properties=None,
                   customer_properties=None,
        ...
        return self.track(event, email=email, id=id, properties=properties,
                          customer_properties=customer_properties,
